package io.tfe.backend.repository;

import io.tfe.backend.TfeNewBackendApp;
import io.tfe.backend.config.Constants;
import io.tfe.backend.config.audit.AuditEventConverter;
import io.tfe.backend.domain.PersistentAuditEvent;
...
import static io.tfe.backend.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
