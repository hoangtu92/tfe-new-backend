package io.tfe.backend.web.rest;

import io.tfe.backend.TfeNewBackendApp;
import io.tfe.backend.config.Constants;
import io.tfe.backend.domain.Authority;
import io.tfe.backend.domain.PersistentToken;
import io.tfe.backend.domain.User;
import io.tfe.backend.repository.AuthorityRepository;
import io.tfe.backend.repository.PersistentTokenRepository;
import io.tfe.backend.repository.UserRepository;
import io.tfe.backend.security.AuthoritiesConstants;
import io.tfe.backend.service.MailService;
import io.tfe.backend.service.UserService;
import io.tfe.backend.service.dto.PasswordChangeDTO;
import io.tfe.backend.service.dto.UserDTO;
import io.tfe.backend.web.rest.errors.ExceptionTranslator;
import io.tfe.backend.web.rest.vm.KeyAndPasswordVM;
import io.tfe.backend.web.rest.vm.ManagedUserVM;
 ...
 */
@SpringBootTest(classes = TfeNewBackendApp.class)
